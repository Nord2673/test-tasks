...
<style>
    ...
    *::before,
    ...
    /*#region callback */
    .app-request-consultation-callback-error {
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        let errorCode = parameters.get("error");
        ...
        document.querySelector(".app-request-consultation-callback-content-description-text").innerHTML += `<br>${errorCode} ${errors.get(errorCode)}`;
    });

    document.addEventListener("DOMContentLoaded", function () {
        let returnButton = document.querySelector(".app-request-consultation-close-callback-error");
        returnButton.addEventListener("click", returnToStartWidget);
    });

    function returnToStartWidget() {
        window.location = "widget-request-consultation-index.php";
    }
</script>